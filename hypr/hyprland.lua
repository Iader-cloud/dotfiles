...
hl.on("hyprland.start", function()
       ...
       hl.exec_cmd("sleep 1 && awww img /home/iader/Downloads/1.jpg")
end)
--
-------------------------------
...
hl.bind("SHIFT + F1", hl.dsp.exec_cmd("sh -c 'f=~/Imágenes/screenshot_$(date +%Y%m%d_%H%M%S).png; grim $f && wl-copy < $f'"))
hl.bind("SHIFT + F2", hl.dsp.exec_cmd("sh -c 'f=~/Imágenes/screenshot_$(date +%Y%m%d_%H%M%S).png; grim -g \"$(slurp)\" $f && wl-copy < $f'"))
...
hl.window_rule({
    ...
    float = true,
    size  = "400 200",
    move  = "monitor_w-420 monitor_h-220",
})
---------------------------
---- RECORDING BINDING ----
---------------------------
